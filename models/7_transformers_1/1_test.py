...
# %% [markdown]
# We will now demonstrate the performance improvements of using nested
...
# is no longer the case. Instead, fully masked rows in
# `scaled_dot_product_attention`. For cases where `nn.MHA` does not employ
# the \"fast-path\", this will also apply.
# 
