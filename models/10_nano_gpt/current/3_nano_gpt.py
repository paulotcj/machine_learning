...
# Model section
# create model
model = GPT(GPTConfig(vocab_size=50304, n_layer = 16, n_head = 16, n_embd = 1024))
...
max_lr = 6e-4 * 3 # 0.0018
min_lr = (max_lr / 3) * 0.1 # 0.00006
...
for step in range(start_step, max_steps):
    ...
    if ((step > 0 and step % sampling_step_gap == 0) or last_step) and use_sampling:
	    ...
	    #-------------------------------------------------------------------------		
        print('------------------')
        print('print the generated text - start')
        ...
        print('print the generated text - end')
        print('------------------')
        print('\n\n')
	    #-------------------------------------------------------------------------
    #-------------------------------------------------------------------------
