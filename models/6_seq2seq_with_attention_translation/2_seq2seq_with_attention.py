...
class EncoderRNN(nn.Module):
    ...
    def __init__(self, input_size, hidden_size, dropout_p=0.1):
        ...
        self.hidden_size = hidden_size # hidden state - standard thing

        self.embedding = nn.Embedding(input_size, hidden_size) # embedding layer, input_size is the number of unique words, hidden_size is the size of the embedding

        self.gru = nn.GRU(hidden_size, hidden_size, batch_first=True) #Gated Recurrent Unit
